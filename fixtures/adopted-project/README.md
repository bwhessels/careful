...
The fixture uses OpenSpec as its durable specification authority. Host-specific execution plans may live under `docs/superpowers/plans/` only when they link to OpenSpec.
