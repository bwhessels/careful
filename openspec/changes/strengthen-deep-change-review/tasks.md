...
- [ ] 2.1 Run and record baseline pressure scenarios against the current workflow skill for distribution-contract omissions.
...
- [ ] 3.1 Run and record a baseline pressure scenario where material findings were fixed but no clean re-review occurred.
